 ...
 */
@interface FIRAuthUISignInButton : UIButton

/** @property provider
    @brief The provider UI instance associated with this button. Can be nil.
 */
@property(nonatomic, strong, readonly, nullable) id<FIRAuthProviderUI> providerUI;
 ...
 */
- (id)initWithFrame:(CGRect)frame providerUI:(id<FIRAuthProviderUI>)providerUI;
