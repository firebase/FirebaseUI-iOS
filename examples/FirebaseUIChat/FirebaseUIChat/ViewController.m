...
- (void)viewDidLoad {
    ...
    NSSortDescriptor * reverseKeySort = [NSSortDescriptor sortDescriptorWithKey:@"key"
                                                                      ascending:NO];
    
    self.dataSource = [[MessageDataSource alloc] initWithRef:self.ref
                                             sortDescriptors:@[reverseKeySort]
