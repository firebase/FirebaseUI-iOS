...
// This file is used for snapshot array diffing, but its only dependency is Foundation,
// so it can be applied to other things as well.
@import Foundation;
...
- (instancetype)initWithInitialArray:(NSArray<ObjectType> *)initialArray
                         resultArray:(NSArray<ObjectType> *)resultArray NS_DESIGNATED_INITIALIZER;
